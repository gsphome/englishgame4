...
/**
 * Returns the SVG icon string for a given learning mode.
 * @param {string} learningMode - The learning mode (e.g., 'flashcard', 'quiz').
 * @returns {string} The SVG string for the icon.
 */
export function getLearningModeIconSvg(learningMode) {
    switch (learningMode) {
        case 'flashcard':
